package com.robert.mybatis.second.test;

import org.apache.ibatis.session.SqlSession;
import org.junit.Test;

import com.robert.mybatis.second.domain.Classes;
import com.robert.mybatis.utils.MybatisUtil;
...
public class SecondTest {
	...
	public void testGetClass() {
		...
		/**
		 * 映射sql的标识字符串， me.gacl.mapping.classMapper是classMapper.
		...
		System.out.println(clazz);// 打印结果：Classes [id=1, name=class_a,
									// teacher=Teacher [id=1, name=teacher1]]
	}
